...
const Card = () => {
    ...
    return (
        <div style={{perspective: 2000}}>
            ...
            className='w-[426px] min-h-[600px] bg-[#e4dfdc] rounded-[30px] border-white px-[40px] py-[24px] cursor-grab relative'>
                <div className='mb-6'>
                    <img src={LogoImg} alt="" />
                </div>
                <h1 className='text-5xl mb-6 font-extrabold'>Nike Air Max Pre-Day</h1>
                <p className='max-w-[300px] text-black mb-6'>Taking the classic look of heritage Nike Running into new realm, the Nike Air Max Pre-Day brings you a fast-paced look that's ready for today's world.</p>
